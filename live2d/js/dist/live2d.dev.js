...
!function (t) {
  ...
  }, r.prototype.hitTestSimpleCustom = function (t, i, e, r) {}, o.prototype = new AMotion(), o.EXPRESSION_DEFAULT = "DEFAULT", o.TYPE_SET = 0, o.TYPE_ADD = 1, o.TYPE_MULT = 2, o.loadJson = function (t) {
    t = modelJson;
    console.log(t);
    var i = new o(),
  ...
  function s() {
    b || (b = !0, function t() {
      _(), (window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame)(t, C);
    }());
  }
  ...
  function d() {
    x["default"].DEBUG_LOG && console.log("Set Session Storage."), sessionStorage.setItem("Sleepy", "1");
  }
  ...
  function g(t) {
    if ("mousewheel" == t.type) ;else if ("mousedown" == t.type) p(t);else if ("mousemove" == t.type) {
      ...
      x["default"].DEBUG_LOG && console.log("Mouse out Window."), c();
  ...
  (function (t) {
    !function () {
      ...
      i._$0s = 1, i._$4s = 2, i._$42 = 0, i._$62 = function (t, e) {
        ...
        var i = _._$fT[t];
        null == i && (i = new a(), i._$r = t, _._$fT[t] = i), i._$0S = x.getSystemTimeMSec();
      }, _.dump = function (t) {
        var i = _._$fT[t];
      ...
      It._$ni = function (t, i, e, r, o, n, s, _, a) {
        ...
        if (a <= 0) {
          var p = h[0],
              f = o[p];
          if (2 == _ && 0 == s) x._$jT(f, 0, n, 0, $);else for (var c = 0; c < $;) {
        ...
        } else if (3 == a) for (var A = o[h[0]], I = o[h[1]], w = o[h[2]], O = o[h[3]], D = o[h[4]], R = o[h[5]], b = o[h[6]], F = o[h[7]], g = l[0], P = l[1], C = l[2], y = 1 - g, S = 1 - P, N = 1 - C, B = N * S * y, U = N * S * g, G = N * P * y, Y = N * P * g, k = C * S * y, V = C * S * g, X = C * P * y, z = C * P * g, c = 0; c < $;) {
          n[u] = B * A[c] + U * I[c] + G * w[c] + Y * O[c] + k * D[c] + V * R[c] + X * b[c] + z * F[c], ++c, n[u + 1] = B * A[c] + U * I[c] + G * w[c] + Y * O[c] + k * D[c] + V * R[c] + X * b[c] + z * F[c], ++c, u += _;
        ...
        return new Date().getTime();
      }, x._$Q = function (t) {}, x._$jT = function (t, i, e, r, o) {
        for (var n = 0; n < o; n++) {
          e[r + n] = t[i + n];
        }
      ...
      Y._$V2 = -1, Y._$W0 = -1, Y._$jr = !1, Y._$ZS = !0, Y._$tr = -1e6, Y._$lr = 1e6, Y._$is = 32, Y._$e = !1, Y.prototype.getDrawDataIndex = function (t) {
        ...
        switch (this._$_L) {
          case STATE_CLOSING:
            r = (e - this._$bb) / this._$Dr, r >= 1 && (r = 1, this._$_L = xt.STATE_CLOSED, this._$bb = e), i = 1 - r;
            break;

          case STATE_CLOSED:
            r = (e - this._$bb) / this._$Cb, r >= 1 && (this._$_L = xt.STATE_OPENING, this._$bb = e), i = 0;
            break;

          case STATE_OPENING:
            r = (e - this._$bb) / this._$mr, r >= 1 && (r = 1, this._$_L = xt.STATE_INTERVAL, this._$12 = this._$T2()), i = r;
            break;

          case STATE_INTERVAL:
            this._$12 < e && (this._$_L = xt.STATE_CLOSING, this._$bb = e), i = 1;
            break;

          case STATE_FIRST:
          default:
            this._$_L = xt.STATE_INTERVAL, this._$12 = this._$T2(), i = 1;
        }
      ...
      xt.STATE_FIRST = "STATE_FIRST", xt.STATE_INTERVAL = "STATE_INTERVAL", xt.STATE_CLOSING = "STATE_CLOSING", xt.STATE_CLOSED = "STATE_CLOSED", xt.STATE_OPENING = "STATE_OPENING", X.prototype = new E(), X._$As = 32, X._$Gr = !1, X._$NT = null, X._$vS = null, X._$no = null, X._$9r = function (t) {
        ...
        if (this._$GS._$Ur(t)) {
          ...
          if (this._$GS._$zr(n, s, o), o <= 0) {
            ...
            e._$Yr._$fL = (1 - k) * ((1 - v) * (p + (f - p) * u) + v * (L + (M - L) * u)) + k * ((1 - v) * (V + (X - V) * u) + v * (H + (W - H) * u)), p = E._$gL + (A._$gL - E._$gL) * h, f = I._$gL + (x._$gL - I._$gL) * h, L = w._$gL + (O._$gL - w._$gL) * h, M = D._$gL + (R._$gL - D._$gL) * h, V = b._$gL + (F._$gL - b._$gL) * h, X = C._$gL + (N._$gL - C._$gL) * h, H = B._$gL + (U._$gL - B._$gL) * h, W = G._$gL + (Y._$gL - G._$gL) * h, e._$Yr._$gL = (1 - k) * ((1 - v) * (p + (f - p) * u) + v * (L + (M - L) * u)) + k * ((1 - v) * (V + (X - V) * u) + v * (H + (W - H) * u)), p = E._$B0 + (A._$B0 - E._$B0) * h, f = I._$B0 + (x._$B0 - I._$B0) * h, L = w._$B0 + (O._$B0 - w._$B0) * h, M = D._$B0 + (R._$B0 - D._$B0) * h, V = b._$B0 + (F._$B0 - b._$B0) * h, X = C._$B0 + (N._$B0 - C._$B0) * h, H = B._$B0 + (U._$B0 - B._$B0) * h, W = G._$B0 + (Y._$B0 - G._$B0) * h, e._$Yr._$B0 = (1 - k) * ((1 - v) * (p + (f - p) * u) + v * (L + (M - L) * u)) + k * ((1 - v) * (V + (X - V) * u) + v * (H + (W - H) * u)), p = E._$z0 + (A._$z0 - E._$z0) * h, f = I._$z0 + (x._$z0 - I._$z0) * h, L = w._$z0 + (O._$z0 - w._$z0) * h, M = D._$z0 + (R._$z0 - D._$z0) * h, V = b._$z0 + (F._$z0 - b._$z0) * h, X = C._$z0 + (N._$z0 - C._$z0) * h, H = B._$z0 + (U._$z0 - B._$z0) * h, W = G._$z0 + (Y._$z0 - G._$z0) * h, e._$Yr._$z0 = (1 - k) * ((1 - v) * (p + (f - p) * u) + v * (L + (M - L) * u)) + k * ((1 - v) * (V + (X - V) * u) + v * (H + (W - H) * u)), p = E._$qT + (A._$qT - E._$qT) * h, f = I._$qT + (x._$qT - I._$qT) * h, L = w._$qT + (O._$qT - w._$qT) * h, M = D._$qT + (R._$qT - D._$qT) * h, V = b._$qT + (F._$qT - b._$qT) * h, X = C._$qT + (N._$qT - C._$qT) * h, H = B._$qT + (U._$qT - B._$qT) * h, W = G._$qT + (Y._$qT - G._$qT) * h, e._$Yr._$qT = (1 - k) * ((1 - v) * (p + (f - p) * u) + v * (L + (M - L) * u)) + k * ((1 - v) * (V + (X - V) * u) + v * (H + (W - H) * u));
          } else {
        ...
        for (var h, l, $, u = r * n, p = 0, f = 0, c = 0, d = 0, g = 0, y = 0, m = !1, T = o; T < u; T += n) {
          ...
          if (v = i[T], L = i[T + 1], P = v * _, S = L * a, P < 0 || S < 0 || _ <= P || a <= S) {
            ...
            if (!m) {
              ...
              c = .5 * (E + I), d = .5 * (A + x), g = .5 * (E - I), y = .5 * (A - x), p -= .5 * (c + g), f -= .5 * (d + y);
            }
        ...
        try {
          ...
          for (var h = i.length, l = t.width, $ = t.height, u = this.context, p = this._$xP, f = this._$uP, c = this._$6r, d = this._$3r, g = nt.tr, y = nt._$Ti, m = nt._$Pi, T = nt._$B, P = 0; P < h; P += 3) {
            ...
            var O = l * r[2 * S],
                ...
                X = Math.sqrt(k * k + V * V),
                z = Y / X;
            It._$ni(F, C, O, D, R - O, b - D, -(b - D), R - O, y), It._$ni(x, w, M, E, A - M, I - E, -(I - E), A - M, m);
            var H = (m[0] - y[0]) / y[1],
                W = Math.min(O, R, F),
                j = Math.max(O, R, F),
                q = Math.min(D, b, C),
            ...
            if (n || (n = 1.2), at.IGNORE_EXPAND && (n = 0), at.USE_CACHED_POLYGON_IMAGE) {
              ...
              if (it.gl_cacheImage = it.gl_cacheImage || {}, !it.gl_cacheImage[P]) {
                ...
                rt.translate(-Q, -Z), nt.clip(rt, g, n, Y, O, D, R, b, F, C, M, E, A, I, x, w), rt.drawImage(t, 0, 0), it.gl_cacheImage[P] = {
                  cacheCanvas: et,
                  cacheContext: rt
                };
              }
            ...
            } else at.IGNORE_CLIP || nt.clip(u, g, n, Y, O, D, R, b, F, C, M, E, A, I, x, w), at.USE_ADJUST_TRANSLATION && (W = 0, j = l, q = 0, J = $), u.drawImage(t, W, q, j - W, J - q, W, q, j - W, J - q);
      ...
      }, window.UtSystem = x, window.UtDebug = _, window.LDTransform = gt, window.LDGL = nt, window.Live2D = at, window.Live2DModelWebGL = ft, window.Live2DModelJS = q, window.Live2DMotion = J, window.MotionQueueManager = ct, window.PhysicsHair = f, window.AMotion = s, window.PartsDataID = l, window.DrawDataID = b, window.BaseDataID = yt, window.ParamID = u, at.init();
      var At = !1;
    }();
  }).call(i, e(7));
}, function (t, i) {
  ...
  o.prototype = new n.L2DBaseModel(), o.prototype.load = function (t, i, e) {
    this.setUpdating(!0), this.setInitialized(!1), console.log(this);
    this.modelHomeDir = i.substring(0, i.lastIndexOf("/") + 1), this.modelSetting = new _["default"]();
    var r = this;
